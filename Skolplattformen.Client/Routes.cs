...
namespace Skolplattformen
{
    ...
    internal static class SkolplattformenBankIdRoutes
    {
    ...
    internal static class SkolplattformenVardnadshavareRoutes
    {
        public static readonly Uri User =
            new("https://etjanst.stockholm.se/vardnadshavare/base/getuserdata");

        public static readonly Uri Children =
            new("https://etjanst.stockholm.se/vardnadshavare/inloggad2/GetChildren");

        public static Uri Calendar(string childId) =>
            new($"https://etjanst.stockholm.se/vardnadshavare/inloggad2/Calender/GetSchoolCalender?childId={childId}&rowLimit=50");

        public static Uri Classmates(string childId) =>
            new($"https://etjanst.stockholm.se/vardnadshavare/inloggad2/contacts/GetStudentsByClass?studentId={childId}");

        public static Uri News(string childId) =>
            new($"https://etjanst.stockholm.se/vardnadshavare/inloggad2/News/GetNewsOverview?childId={childId}");

        public static Uri NewsDetails(string childId, string newsId) =>
            new($"https://etjanst.stockholm.se/vardnadshavare/inloggad2/News/GetNewsArticle?newsItemId={newsId}&childId={childId}");

        public static Uri Image(string url) =>
            new($"https://etjanst.stockholm.se/vardnadshavare/inloggad2/NewsBanner?url={url}");

        public static Uri Notifications(string childId) =>
            new($"https://etjanst.stockholm.se/vardnadshavare/inloggad2/Overview/GetNotification?childId={childId}");

        public static Uri Menu(string childId) =>
            new($"https://etjanst.stockholm.se/vardnadshavare/inloggad2/Matsedel/GetMatsedelRSS?childId={childId}");

        public static Uri Schedule(string childId, DateTime fromDate, DateTime endDate) =>
            new($"https://etjanst.stockholm.se/vardnadshavare/inloggad2/Calender/GetSchema?childId={childId}&startDate={fromDate}&endDate={endDate}");
    }
}
